<template>
    <div class="shoplist">
        <section v-for="item in shopList" @click="$router.push({name:'shop',query:{id:item._id}})" class="index-container">
...
<script>
    ...
    export default {
        ...
        async mounted(){
            const data = await axios.get("/getShopByTypeId/"+this.$route.params.id);
            this.shopList = data.shopList;
            console.log(this.$route.params.id,123,this.shopList);
        }
    }
</script>
